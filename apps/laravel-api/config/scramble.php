...
return [
    ...
    'middleware' => [
        'web',
        // RestrictedDocsAccess::class // Removed to allow public access in production
    ],
    ...
    /**
     * Custom validation messages will be used from Laravel's validation system
     * These messages are defined in the controllers and will be returned in API responses
     */
];
